...
git clone https://github.com/Lienol/openwrt -b 21.02
git clone https://github.com/Lienol/openwrt-packages packages -b 21.02
git clone https://github.com/Lienol/openwrt-luci luci -b 21.02
